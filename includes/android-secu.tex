...
For an application to run on the Android operating system and access to critical resources, it should have explicitly been allowed to do so by the system. %TODO pas très clair
...
\section{Android ecosystem and security}
...
The Android market is very fragmented, any manufacturer is able to port and deploy the Android operating system to its smartphone models.
When a manufacturer uses Android on a smartphone, Google loose the ability to control efficiently the system.
The system update process or even the presence of the Android Play Store is dependent of the will of the manufacturer.\\

This lack of efficient control requires  the manufacturer's action to publish fix of known vulnerabilities.
...
The large choice of devices and installation medium (Play Store, alternative marketplaces,...) is an marketing argument but also a security weakness.