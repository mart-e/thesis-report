...
Even when an application is distributed by the Play Store, the user should check the asked permissions carefully.
This is valid at each update where the permissions can change.
Several cases of malicious applications on the Play Store have been detected in the past (see below).
...
These applications should be considered as are the warrez websites on the Windows operating system: highly risky in term of malware propagation, these applications could have been manipulated to inject malicious code.\\
