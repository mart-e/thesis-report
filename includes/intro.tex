...
The use of technology has become an integral part of human life.
...
The smartphone penetration rate is constantly rising and, in a few years, it is expected that the majority of people will own such a device in developed countries.
...
Privacy advocates call for the destruction of RFID tags when not in use (for instance after buying an item where the tag has been used for inventory purpose) or advise covering it with a aluminium foil.\\
