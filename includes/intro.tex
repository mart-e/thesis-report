...
The consequences of compromising such data can be very high for an end-user.
...
For instance, it is possible to create a fake access point on which victims may connect and reveal, in the best case, their credentials for the access point or more sensitive information during the navigation on the Internet\footnote{During the master in computer sciences at the UCL, the pattern of such an attack has been demonstrated at the occasion of a security. A fake FON access point was created to retrieve FON credentials as well as passwords during the surf using inexpensive material.}.
...
This license allows you to copying, distribution, transmission, adaptation the work and making commercial use of the work under the following conditions:
