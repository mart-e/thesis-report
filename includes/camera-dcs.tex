...
Gaining an administrator access could be useful for the burglar to be able to disable the camera surveillance mechanisms such as motion detection during his future visit.
...
For future researches concerning this camera, there are several points where researches where started but did not reached to a conclusion and could be continued in future work.
