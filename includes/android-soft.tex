...
As efficient computation of the signal strength would have required long monitoring and observation on a large number of devices and areas, the computation and weighting of the variables has been done based on personal observations.
