...
It is advised to read them in the presented order for a better understanding as they rely on each other. %TODO verifier rely on each other
...
%TODO ajouter footnote nombre telechargement foursquare
