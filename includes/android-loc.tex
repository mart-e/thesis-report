...
The localisation of the user is a key function of Android.
...
The comparison is done using the script \texttt{compare\_dump.py} present in Appendix X which use a hash function on each file present in the dump to detect a modification.
...
\subsection{Impact of location requests}
