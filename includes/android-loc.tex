...
The advantage of this method is that for an accuracy of about 100 metres, the localisation is faster than using GPS, it works indoors, consumes less battery power than a GPS receiver chip and only one access point is enough to locate a device.\\
...
Companies have quickly understood the value of this information and the economic interest of having their own database as a betterment for location aware applications.
